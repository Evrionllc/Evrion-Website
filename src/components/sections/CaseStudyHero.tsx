        ...
        {project.liveUrl && (
          ...
          >
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group inline-flex min-h-11 items-center gap-2 rounded-full bg-foreground px-5 font-mono text-xs tracking-[0.2em] text-black uppercase transition-opacity hover:opacity-90"
            >
              Visit live
