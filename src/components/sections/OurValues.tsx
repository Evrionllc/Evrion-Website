    ...
    <section aria-label="Our values" className="relative py-20 sm:py-40">
      <div className="container-x grid gap-16 lg:grid-cols-[1fr_1.1fr] lg:gap-24">
        <div className="lg:sticky lg:top-32 lg:self-start">
          <SectionHeading label="Our Values" title="The principles behind the work." />
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.7, delay: 0.2 }}
            className="mt-8 flex max-w-md flex-col gap-5 text-sm leading-relaxed text-foreground/80 sm:text-[1rem]"
          >
            <p>
              Every project is shaped by the same set of principles. They guide
              how we think, how we make decisions, and what we choose not to
              compromise.
            </p>
          </motion.div>
        </div>
