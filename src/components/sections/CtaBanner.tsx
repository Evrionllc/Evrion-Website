...
export default function CtaBanner({
  ...
  return (
    <section
      ...
      className="relative overflow-hidden border-t border-line bg-elevated py-20 sm:py-36"
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-48 left-1/2 h-[420px] w-[720px] -translate-x-1/2 rounded-full bg-iris/15 blur-[140px] will-change-transform"
      />
