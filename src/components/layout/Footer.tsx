    ...
    <footer className="relative overflow-hidden border-t border-line">
      <div className="container-x py-16">
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <nav aria-label="Footer" className="flex flex-col items-start gap-1 sm:gap-3">
            ...
            {NAV_LINKS.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="block py-3 text-sm text-muted transition-colors hover:text-foreground sm:py-0"
              >
                {link.label}
              </Link>
            ))}
          ...
          <div className="flex flex-col items-start gap-1 sm:gap-3">
            ...
            <a
              ...
              className="mt-2 block py-3 text-sm text-mint hover:underline sm:py-0"
            >
              {SITE.email}
            </a>
          </div>
