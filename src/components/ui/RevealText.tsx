  ...
  useEffect(() => {
    ...
    mm.add("(prefers-reduced-motion: no-preference)", () => {
      ...
      gsap.to(words, {
        ...
        stagger: 0.045,
        delay,
        // The reveal plays exactly once; once the words have landed there's no
        // reason to keep a compositing layer pinned on each of them, so drop
        // the will-change hint to free the layer for the rest of the session.
        onComplete: () => {
          words.forEach((w) => {
